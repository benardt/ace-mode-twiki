// https://github-wiki-see.page/m/svejooo/ace/wiki/Creating-or-Extending-an-Edit-Mode
...
define("ace/mode/twiki_highlight_rules",["require","exports","module","ace/config","ace/lib/oop","ace/lib/lang","ace/mode/text_highlight_rules","ace/mode/html_highlight_rules"], function(require, exports, module) {
"use strict";
...
var TwikiHighlightRules = function() {
    ...
    this.addRules({
        "basic" : [{
            ...
            token : ["text", "markup.underline", "text", "string", "text"],
            regex : "(\\[{2})(" + escaped("]") + ")(\\]\\[)("+ escaped("]") + ")(\\]{2})"
        }, { // link by url
...
oop.inherits(TwikiHighlightRules, TextHighlightRules);

exports.TwikiHighlightRules = TwikiHighlightRules;
});

define("ace/mode/folding/twiki",["require","exports","module","ace/lib/oop","ace/mode/folding/fold_mode","ace/range"], function(require, exports, module) {
"use strict";
...
define("ace/mode/twiki",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/javascript","ace/mode/xml","ace/mode/html","ace/mode/twiki_highlight_rules","ace/mode/folding/twiki","ace/mode/javascript","ace/mode/html","ace/mode/sh","ace/mode/sh","ace/mode/xml","ace/mode/css"], function(require, exports, module) {
"use strict";
...
var TwikiHighlightRules = require("./twiki_highlight_rules").TwikiHighlightRules;
var TwikiFoldMode = require("./folding/twiki").FoldMode;

var Mode = function() {
    this.HighlightRules = TwikiHighlightRules;
    ...
    this.foldingRules = new TwikiFoldMode();
...
(function() {
    ...
    this.$id = "ace/mode/twiki";
}).call(Mode.prototype);

exports.Mode = Mode;
});                (function() {
                    window.require(["ace/mode/twiki"], function(m) {
